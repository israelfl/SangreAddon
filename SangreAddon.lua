...
--     return (SangreAddon.db.char.highlight_spec.spec_name == spec_name
--             and SangreAddon.db.char.highlight_spec.class_name == class_name)
-- end
...
--         return false
--     end
--     if SangreAddon.db.char.filter_specs[class_name] then
--         return not SangreAddon.db.char.filter_specs[class_name][spec_name]
--     end
--     return false
-- end

-- local function classNamesFiltered()
--     if SangreAddon.db.char.filter_class_names then
--         return true
--     end
-- end
...
--         prefix = ""
--     end
--     local left_text = prefix .. "|T" .. Sangre_spec_icons[class_name][spec_name] .. ":14|t " .. spec_name
...
--     if Sangre_items[itemId] == nil then
--         return ;
--     end
--     local item = Sangre_items[itemId]
...
function SangreAddon:initSangre()
